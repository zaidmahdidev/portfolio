          ...
          <div className="mt-8 flex items-center justify-between border-t border-slate-100 pt-6 dark:border-white/5">
            ...
            <div className="flex items-center gap-3">
              ...
              {asset.appStoreUrl && (
                ...
                >
                  <svg className="size-5" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M15.54 3.79c-.64 1-1.68 1.6-2.73 1.49-.17-1.14.33-2.3 1.05-3.05.68-.8 1.76-1.35 2.76-1.27.17 1.15-.33 2.27-1.08 2.83zm-3.66 2.37c-1.57.03-3 1.03-3.8 1.03-1.12 0-2.8-1.39-4.13-1.39-1.92 0-3.79 1.16-4.79 3.02-2.12 3.65-.54 9.17 1.51 12.18.99 1.45 2.15 3.09 3.73 3.04 1.49-.05 2.1-.96 3.9-.96 1.83 0 2.35.96 3.93.94 1.62-.03 2.63-1.5 3.59-2.92 1.13-1.64 1.6-3.23 1.62-3.32-.04-.01-3.13-1.2-3.16-4.82-.03-3.02 2.45-4.48 2.56-4.54-1.42-2.06-3.62-2.34-4.4-2.42-1.9-.22-3.82 1.14-4.56 1.14z"/>
                  </svg>
                </a>
              )}
            </div>
