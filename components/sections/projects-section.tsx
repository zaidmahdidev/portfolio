              ...
              {asset.appStoreUrl && (
                ...
                >
                  <svg className="size-5" viewBox="0 0 384 512" fill="currentColor">
                    <path d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.1-44.6-35.9-2.8-74.3 22.7-93.1 22.7-18.9 0-46.3-21-82.8-21-51.4 0-102.3 33.2-127.3 84.8-54.6 112.5-38.3 234.3 31.2 315.4 34.4 40.1 76.5 45.6 110.8 44.5 35.8-1.1 48-21 91.5-21 42.7 0 54.3 21 91.5 21 35.9 0 71.3-15.6 100.8-49.4 33.3-39 46.5-77.9 47.5-80.1-1.5-1-84.7-32.5-86.1-87.5zM277.8 71.4c21.8-26.2 36.4-62.8 32.4-98.9-31.5 1.3-70 21-92.4 47.1-19.1 22.3-36.3 59.8-31.6 94.7 35.4 2.8 70.1-16.7 91.6-42.9z"/>
                  </svg>
                </a>
              )}
            </div>
